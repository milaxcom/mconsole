...
namespace Milax\Mconsole\Http\Uploads;
...
class UploadHandler
{
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
            $index, $content_range)
    {
        return sprintf('%s~%s.%s', Str::slug(pathinfo($name, PATHINFO_FILENAME)), md5(Str::random(10) . time()), pathinfo($name, PATHINFO_EXTENSION));
    }
